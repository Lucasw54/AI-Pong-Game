...
for i in range(num_games):
    ...
    ball_x = 0.5
    ball_y = 0.5
    ball_vx = random.uniform(-0.05, 0.05)  # Generate a random velocity in the x direction
    ball_vy = random.uniform(-0.05, 0.05)  # Generate a random velocity in the y direction
    paddle_y = 0.5
    paddle_v = 0.04
